  ...
  chalk.bold(
    chalk.green(
      "Welcome to Anurag's repl " +
        userName +
        " :). You will be asked some interesting question's on Hockey and your score will be calculated accrodingly.\n"
    )
  )
);
...
var questions = [
  ...
  {
    question:
      "4.) What are the dimensions of the goal at each end of the hockey field?",
  ...
  {
    question:
      "8.) Which nation has been crowned as World Champions of Hockey four times?",
